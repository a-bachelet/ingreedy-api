class UseCompositePrimaryKeys < ActiveRecord::Migration[7.1]
  ...
  def down
    ...
    change_table :fridge_ingredients do |t| t.bigserial :id end
    change_table :recipe_ingredients do |t| t.bigserial :id end
    change_table :recipe_tags do |t| t.bigserial :id end
